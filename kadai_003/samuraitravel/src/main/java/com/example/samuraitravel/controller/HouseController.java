...
public class HouseController {
	...
	public String show(
		...
		if (userDetails != null) {
			hasReviewed = reviewRepository.existsByHouseAndUser(
					house,
					userDetails.getUser());
			model.addAttribute("loginUser", userDetails.getUser());
			isFavorite = favoriteRepository.existsByUserAndHouse(
					userDetails.getUser(),
					house);
	...
	public String index(@PathVariable Integer houseId,
		...
		Page<Review> reviewPage = reviewRepository.findByHouseOrderByCreatedAtDesc(
				house,
				pageable);
		if (userDetails != null) {
